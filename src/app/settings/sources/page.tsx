    ...
    return (
        <div>
                            ...
                            <>
                                <div className="md:col-span-2">
                                    ...
                                    <p className="text-xs text-gray-400 mt-1">
                                        Поддерживаются: CSV, Excel, XML (CommerceML)
                                    </p>
                                </div>
                            </>
                        )}
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                            ...
                            return (
                                <div
                                    ...
                                    onClick={() => {
                                        ...
                                        // Загружаем сохранённый файл из config
                                        try {
                                            const config = JSON.parse(source.config || '{}');
                                            if (config.file_content) {
                                                // Если файл был сохранён — восстанавливаем
                                                ...
                                                if (lines.length > 0) {
                                                    ...
                                                    // Восстанавливаем маппинг, если он есть
                ...
                {/* Блок импорта для выбранного источника */}
                {showImportBlock && selectedSource && (
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mt-6">
                        <div className="flex items-center justify-between mb-4">
                            <h3 className="text-lg font-semibold text-gray-900">
                                Импорт данных: {selectedSource.name}
                            </h3>
                            <button
